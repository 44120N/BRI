    ...
    return (
        <>
            <Stack direction={"column"} sx={{backgroundColor: "#f5f5f5"}}>
                ...
                >
                    <Stack>
                        ...
                        <Divider sx={{border:'.3vh solid #222', width:'100%'}} />
                    </Stack>
                    <Typography
                        variant="p"
                        textAlign={"justify"}
                    ...
                    >
                        Mempelajari design dan code lebih terpercaya dengan mengikuti roadmap yang telah kami design
                    </Typography>
                    <Grid2 container spacing={2} direction={'row'} justifyContent={"center"} alignItems={'center'} columns={{xs:1, sm:2, md:4}}>
                        {courses.map((item)=>(
            ...
            <Stack
                ...
                gap={{xs:6, md:16}}
            >
                <Stack direction={'column'} gap={3} maxWidth={{xs:'100vw', md:'50vw'}} px={3} py={2} 
                    sx={{
                ...
                >
                    <Stack gap={0.6} direction={'column'}>
                        ...
                        >
                            Pilih dan belajar puluhan kursus online di <Typography variant="b" color="primary" fontWeight={800}>Rumah Ilmiah</Typography> dan dapatkan banyak keuntungannya.
                        </Typography>
                    </Stack>
                    <Stack direction={'column'} gap={3}>
                        ...
                        >
                            ...
                            <Typography
                                ...
                                fontSize={{xs: ".7em",sm:"1em"}}
                            >
                                Belajar lebih terarah dengan mengikuti pilihan kurikulum berkualitas yang kami rancang untuk Anda.
                            </Typography>
                        </Stack>
                        <Stack 
                            direction={'column'} 
                        ...
                        >
                            ...
                            <Typography
                                ...
                                fontSize={{xs: ".7em",sm:"1em"}}
                            >
                                Ikuti kursus online dan dapatkan materi penunjang untuk memaksimalkan pembelajaran Anda.
                            </Typography>
                        </Stack>
                        <Stack 
                            direction={'column'} 
                        ...
                        >
                            ...
                            <Typography
                                ...
                                fontSize={{xs: ".7em",sm:"1em"}}
                            >
                                Uji kemampuan Anda dengan mengerjakan rangkaian tes (pre test dan post test) hingga kuis yang dapat mengukur tingkat pemahaman Anda
                            </Typography>
                        </Stack>
                    </Stack>
                </Stack>
            ...
            >
                ...
                >
                    ...
                    <Stack gap={0.6} direction={'column'}>
                        ...
                        >
                            Nikmati semua akses ke <Typography variant="b" color="primary" fontWeight={800}>Rumah Ilmiah</Typography> mulai dari <Typography variant="b" color="secondary" fontWeight={800}>Rp. 2.000,-</Typography> perhari.
                        </Typography>
                    </Stack>
                    ...
                    {/* Buttons */}
                    <Stack direction="row" gap={2} mt={2} justifyContent={{ xs: "center", sm: "start" }}>
                        <Button bgcolor="primary" color={"#fff"} bdcolor={'#000'} sx={{ fontWeight: "bold" }}>
