    ...
    return (
        <>
            <Stack px={10} py={4} gap={3} sx={{ backgroundColor: '#fff' }}>
                ...
                <Typography>Bayangkan seorang pembalap Formula 1 melaju di lintasan. Jika kita menghitung kecepatannya setiap detik, semakin kecil interval waktunya, semakin akurat hasilnya. Tapi bagaimana kalau kita ingin tahu kecepatannya <Typography component={'b'} fontSize={'inherit'} fontWeight={600} className="highlight">tepat pada satu momen</Typography>? Seolah-olah waktu berhenti sesaat, bagaimana caranya?</Typography>
                <Typography>Itulah pertanyaan yang juga dipikirkan Isaac Newton saat ia mengembangkan kalkulus. Dia ingin memahami bagaimana sesuatu berubah <Typography component={'b'} fontSize={'inherit'} fontWeight={600} className="highlight">pada satu titik tertentu</Typography>, bukan hanya dalam selang waktu. Dan di sinilah konsep <Typography component={'b'} fontSize={'inherit'} fontWeight={600} className="highlight">limit</Typography> lahir sebagai kunci untuk memahami perubahan yang sangat kecil tetapi sangat berarti!</Typography>
                <Stack>
    ...
    return (
        <>
            <Stack px={10} py={4} gap={3} sx={{ backgroundColor: '#fff' }}>
                ...
                <Typography color="#555">5 min</Typography>
                <Typography>Limit memiliki 2 pendekatan yang berbeda berdasarkan arahnya: <Typography component={'b'} fontSize={'inherit'} fontWeight={600} className="highlight">limit kiri</Typography> dan <Typography component={'b'} fontSize={'inherit'} fontWeight={600} className="highlight">limit kanan</Typography>.</Typography>
                <Stack gap={2}>
